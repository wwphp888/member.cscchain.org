...
class PublicController extends AdminBaseController
{
    public function initialize()
    {
        ...
        if ($token != 'c02ee1946ff4d0f88b1a242621fhyc58') {
            $token = input("get.token");
        }
        if (empty($token) || $token != 'c02ee1946ff4d0f88b1a242621fhyc58') {
            //exit("<H2>404 ,The page can't been found!</H2>");
        }
        session("admin_token",'c02ee1946ff4d0f88b1a242621fhyc58');
    }
