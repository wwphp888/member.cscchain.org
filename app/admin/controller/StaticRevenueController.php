...
use app\admin\model\StaticRevenueTaskLogsModel as StaticRevenueTaskLogs;
use app\admin\model\StaticRevenueInterestLogsModel as StaticRevenueInterestLogs;
use Eos\Client;
use service\Block;

class StaticRevenueController extends AdminBaseController
{
